        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn signin(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/proto.getting.v1.Auth/Signin",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.getting.v1.Auth", "Signin"));
        ...
        pub async fn signup(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.getting.v1.Auth/Signup",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.getting.v1.Auth", "Signup"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod auth_server {
                ...
                "/proto.getting.v1.Auth/Signin" => {
                    ...
                    for SigninSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Auth>::signin(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.getting.v1.Auth/Signup" => {
                    ...
                    for SignupSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Auth>::signup(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: Auth> tonic::server::NamedService for AuthServer<T> {
        const NAME: &'static str = "proto.getting.v1.Auth";
    }
}
/// Generated client implementations.
pub mod user_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get(
        ...
        ) -> std::result::Result<tonic::Response<super::UserDto>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.getting.v1.User/Get",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("proto.getting.v1.User", "Get"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn update(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.getting.v1.User/Update",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.getting.v1.User", "Update"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn stream_list(
            &mut self,
            request: impl tonic::IntoRequest<super::StreamListRequest>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::UserDto>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.getting.v1.User/StreamList",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.getting.v1.User", "StreamList"));
...
pub mod user_server {
    ...
    pub trait User: Send + Sync + 'static {
        ...
        /// Server streaming response type for the StreamList method.
        type StreamListStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::UserDto, tonic::Status>,
            >
            + Send
            + 'static;
        async fn stream_list(
            &self,
            request: tonic::Request<super::StreamListRequest>,
        ) -> std::result::Result<tonic::Response<Self::StreamListStream>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/proto.getting.v1.User/Get" => {
                    ...
                    for GetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as User>::get(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.getting.v1.User/Update" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateSvc<T: User>(pub Arc<T>);
                    impl<T: User> tonic::server::UnaryService<super::UpdateUserRequest>
                    for UpdateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as User>::update(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.getting.v1.User/StreamList" => {
                    #[allow(non_camel_case_types)]
                    struct StreamListSvc<T: User>(pub Arc<T>);
                    impl<
                        T: User,
                    > tonic::server::ServerStreamingService<super::StreamListRequest>
                    for StreamListSvc<T> {
                        type Response = super::UserDto;
                        type ResponseStream = T::StreamListStream;
                        type Future = BoxFuture<
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as User>::stream_list(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = StreamListSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T: User> tonic::server::NamedService for UserServer<T> {
        const NAME: &'static str = "proto.getting.v1.User";
    }
}
