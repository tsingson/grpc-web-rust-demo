...
const (
	...
	UserGetProcedure = "/getting.v1.User/Get"
	// UserUpdateProcedure is the fully-qualified name of the User's Update RPC.
	UserUpdateProcedure = "/getting.v1.User/Update"
	// UserStreamListProcedure is the fully-qualified name of the User's StreamList RPC.
	UserStreamListProcedure = "/getting.v1.User/StreamList"
)

// UserClient is a client for the getting.v1.User service.
...
// NewUserClient constructs a client for the getting.v1.User service. By default, it uses the
...
// StreamList calls getting.v1.User.StreamList.
...
// UserHandler is an implementation of the getting.v1.User service.
...
func NewUserHandler(svc UserHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/getting.v1.User/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserHandler) Get(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.UserDto], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("getting.v1.User.Get is not implemented"))
}
...
func (UnimplementedUserHandler) Update(context.Context, *connect.Request[v1.UpdateUserRequest]) (*connect.Response[v1.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("getting.v1.User.Update is not implemented"))
}
...
func (UnimplementedUserHandler) StreamList(context.Context, *connect.Request[v1.StreamListRequest], *connect.ServerStream[v1.UserDto]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("getting.v1.User.StreamList is not implemented"))
}
